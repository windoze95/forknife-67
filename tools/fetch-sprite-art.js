...
const ART = {
  // Override textures, verified against the rendered current-season grid.
  jonesy: 'BR_Creature_Sprite_Jonesy_L',
  'jonesy.gold': 'BR_Creature_Sprite_Jonesy_Gold_L',
  'jonesy.cheatmaster': 'BR_Creature_Sprite_Jonesy_Cheatmaster_L',
  'jonesy.loothacker': 'BR_Creature_Sprite_Jonesy_Hacker_L',
  adventure: 'BR_Creature_Sprite_Dwarf_L',
  'adventure.gold': 'BR_Creature_Sprite_Dwarf_Gold_L',
  'adventure.cheatmaster': 'BR_Creature_Sprite_Dwarf_Cheatmaster_L',
  'adventure.loothacker': 'BR_Creature_Sprite_Dwarf_Hacker_L',
  bush: 'BR_Creature_Sprite_BushRanger_L',
  'bush.gold': 'BR_Creature_Sprite_BushRanger_Gold_L',
  'bush.cheatmaster': 'BR_Creature_Sprite_BushRanger_Cheatmaster_L',
  'bush.loothacker': 'BR_Creature_Sprite_BushRanger_Hacker_L',
  sonic: 'BR_Creature_Sprite_NarrowFlea_Obsidian_L',
  'sonic.gold': 'BR_Creature_Sprite_NarrowFlea_Obsidian_Gold_L',
  'sonic.cheatmaster': 'BR_Creature_Sprite_NarrowFlea_Obsidian_Cheatmaster_L',
  'sonic.loothacker': 'BR_Creature_Sprite_NarrowFlea_Hacker_L',
  tails: 'BR_Creature_Sprite_NarrowFlea_Monkey_L',
  'tails.gold': 'BR_Creature_Sprite_NarrowFlea_Monkey_Gold_L',
  'tails.cheatmaster': 'BR_Creature_Sprite_NarrowFlea_Monkey_Cheatmaster_L',
  'tails.loothacker': 'BR_Creature_Sprite_NarrowFlea_Monkey_Hacker_L',
  shadow: 'BR_Creature_Sprite_NarrowFlea_Scribe_L',
  'shadow.gold': 'BR_Creature_Sprite_NarrowFlea_Scribe_Gold_L',
  'shadow.cheatmaster': 'BR_Creature_Sprite_NarrowFlea_Scribe_Cheatmaster_L',
  'shadow.loothacker': 'BR_Creature_Sprite_ReloadOverTime_Hacker_L',
  eightbit: 'BR_Creature_Sprite_EightBitBlaster_L',
  'eightbit.gold': 'BR_Creature_Sprite_EightBitBlaster_Gold_L',
  'eightbit.cheatmaster': 'BR_Creature_Sprite_EightBitBlaster_Cheatmaster_L',
  'eightbit.loothacker': 'BR_Creature_Sprite_EightBitBlaster_Hacker_L',
  jackrabbit: 'BR_Creature_Sprite_JazzJackrabbit_L',
  'jackrabbit.gold': 'BR_Creature_Sprite_JazzJackrabbit_Gold_L',
  'jackrabbit.cheatmaster': 'BR_Creature_Sprite_JazzJackrabbit_Cheatmaster_L',
  'jackrabbit.loothacker': 'BR_Creature_Sprite_DoubleJump_Hacker_L',
  crown: 'BR_Creature_Sprite_Crown_L',
  'crown.gold': 'BR_Creature_Sprite_Crown_Gold_L',
  'crown.cheatmaster': 'BR_Creature_Sprite_Crown_Cheatmaster_L',
  'crown.loothacker': 'BR_Creature_Sprite_Crown_Hacker_L',
  killswitch: 'BR_Creature_Sprite_Killswitch_L',
  'killswitch.gold': 'BR_Creature_Sprite_Killswitch_Gold_L',
  'killswitch.cheatmaster': 'BR_Creature_Sprite_Killswitch_Cheatmaster_L',
  'killswitch.loothacker': 'BR_Creature_Sprite_Killswitch_Hacker_L',
  klombo: 'BR_Creature_Sprite_Klombo_L',
  'klombo.gold': 'BR_Creature_Sprite_Klombo_Gold_L',
  'klombo.cheatmaster': 'BR_Creature_Sprite_Klombo_Cheatmaster_L',
  'klombo.loothacker': 'BR_Creature_Sprite_Klombo_Hacker_L',
  megaman: 'BR_Creature_Sprite_ImprovedSlide_L',
  overshield: 'BR_Creature_Sprite_Overshield_L',
  'overshield.gold': 'BR_Creature_Sprite_Overshield_Gold_L',
  'overshield.cheatmaster': 'BR_Creature_Sprite_Overshield_Cheatmaster_L',
  'overshield.loothacker': 'BR_Creature_Sprite_Overshield_Hacker_L',
  xray: 'BR_Creature_Sprite_WinnerB_L',
  'xray.gold': 'BR_Creature_Sprite_WinnerB_Gold_L',
  'xray.cheatmaster': 'BR_Creature_Sprite_WinnerB_Cheatmaster_L',
  'xray.loothacker': 'BR_Creature_Sprite_WinnerB_Hacker_L',
  onigiri: 'BR_Creature_Sprite_WinnerC_L',
  'onigiri.gold': 'BR_Creature_Sprite_WinnerC_Gold_L',
  'onigiri.cheatmaster': 'BR_Creature_Sprite_WinnerC_Cheatmaster_L',
  'onigiri.loothacker': 'BR_Creature_Sprite_WinnerC_Hacker_L',
  stormscout: 'BR_Creature_Sprite_StormScout_L',
  'stormscout.gold': 'BR_Creature_Sprite_StormScout_Gold_L',
  'stormscout.cheatmaster': 'BR_Creature_Sprite_StormScout_Cheatmaster_L',
  'stormscout.loothacker': 'BR_Creature_Sprite_StormScout_Hacker_L',
